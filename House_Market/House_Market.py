...
df_nb_chambres = pd.read_csv("House_Market/nombre_de_chambres.csv")
df_nb_sdb = pd.read_csv("House_Market/nombre_de_sdb.csv")
df_superficie = pd.read_csv("House_Market/superficie.csv")
